	...
	<body>
		...
		<div id="block_page" class="container">
			<div class= "formulaire">
				<form method="post" action="cibleInscription.php" enctype="multipart/form-data" role="form" class="form-inline">
					...
					<section class="row">
						<p>
							...
							<div class="form-group col-md-4">  <!--informations générales-->
								Nom (du vendeur ou de la boutique de vente) *:
								<br/>
							...
							<div class="form-group col-md-4"> <!--informations complémentaires-->
								Pays *:
								<br/>
